    ...
    public static partial class SettingsManager
    {
        ...
        public static readonly List<Tab> AllSettingsTabs = new()
        {
            ...
            new MetadataTab("Experimental", icon: "Beaker", new CharacterPreviewBuilder())
            {
                ...
                nameof(Settings.CustomVocalsCharacterFemale),
                nameof(Settings.AutoSelectVocalistByGender),
                nameof(Settings.CustomGuitarCharacter),
                nameof(Settings.CustomBassCharacter),
                nameof(Settings.CustomDrumsCharacter),
                nameof(Settings.CustomKeysCharacter),
                nameof(Settings.CustomGuitar),
                nameof(Settings.CustomVenue),
